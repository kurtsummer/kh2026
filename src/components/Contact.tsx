import { Mail, Phone, MapPin, Instagram, Facebook, Linkedin, ArrowRight, Send, Smile, Camera, Heart, Sparkles } from "lucide-react";
          ...
          <div className="space-y-16">
            <div className="space-y-8">
               <div className="bg-[#FF7E67]/10 p-4 rounded-3xl w-fit animate-bounce">
                  <Smile className="w-8 h-8 text-[#FF7E67] fill-current" />
               </div>
               <h2 className="text-[#FF7E67] font-black tracking-widest uppercase text-sm">Kontakt</h2>
               <h3 className="text-4xl md:text-6xl font-black text-[#2D3436] leading-tight">Lass uns bunte <span className="text-[#45B7AF]">Pläne</span> schmieden!</h3>
               <p className="text-xl text-[#2D3436]/70 leading-relaxed max-w-lg font-medium">
                 Egal ob Sie eine Idee haben oder einfach nur mal Hallo sagen wollen – wir freuen uns riesig auf Ihre Nachricht!
               </p>
            </div>
            ...
            <div className="grid gap-10">
               <div className="flex gap-8 group">
                  ...
                  <div className="flex flex-col justify-center">
                     ...
                     <a href="mailto:hallo@max-macht-fotos.de" className="text-xl font-black text-[#2D3436] hover:text-[#FF7E67] transition-colors">hallo@max-macht-fotos.de</a>
                  </div>
               </div>
               ...
               <div className="flex gap-8 group">
                  ...
                  <div className="flex flex-col justify-center">
                     <p className="text-[10px] font-black text-[#2D3436]/40 uppercase tracking-widest mb-1 leading-none">Telefon & WhatsApp</p>
               ...
               <div className="flex gap-8 group">
                  ...
                  <div className="flex flex-col justify-center">
                     <p className="text-[10px] font-black text-[#2D3436]/40 uppercase tracking-widest mb-1 leading-none">Das bunte Studio</p>
                     <p className="text-xl font-black text-[#2D3436]">Regenbogengasse 1, 12345 Musterhausen</p>
                  </div>
               </div>
            </div>

            <div className="space-y-8 pt-12 border-t border-[#2D3436]/5">
               <p className="text-xs font-black text-[#2D3436]/40 uppercase tracking-widest">Join our Happy Community</p>
               <div className="flex gap-4">
                  {[
                    { icon: <Instagram />, label: "Instagram", color: "hover:bg-[#E1306C]" },
                    { icon: <Facebook />, label: "Facebook", color: "hover:bg-[#4267B2]" },
                    { icon: <Linkedin />, label: "LinkedIn", color: "hover:bg-[#2867B2]" }
                  ].map((social, i) => (
             ...
             <form className="space-y-10 relative z-10" onSubmit={(e) => e.preventDefault()}>
                <div className="grid md:grid-cols-2 gap-8">
                   <div className="space-y-3">
                      <label className="text-xs font-black text-[#2D3436] uppercase tracking-widest ml-1">Wie heißt du?</label>
                      <Input placeholder="Dein Name" className="bg-white border-none rounded-3xl py-8 px-8 focus:ring-4 focus:ring-[#FF7E67]/20 transition-shadow shadow-sm font-bold placeholder:font-medium placeholder:text-[#2D3436]/30" />
                   </div>
                   <div className="space-y-3">
                      <label className="text-xs font-black text-[#2D3436] uppercase tracking-widest ml-1">Deine E-Mail</label>
                      <Input type="email" placeholder="hallo@du.de" className="bg-white border-none rounded-3xl py-8 px-8 focus:ring-4 focus:ring-[#45B7AF]/20 transition-shadow shadow-sm font-bold placeholder:font-medium placeholder:text-[#2D3436]/30" />
                   </div>
                </div>

                <div className="space-y-3">
                   <label className="text-xs font-black text-[#2D3436] uppercase tracking-widest ml-1">Was planen wir?</label>
                   <div className="relative">
                      <select className="w-full bg-white border-none rounded-3xl py-6 px-8 focus:ring-4 focus:ring-[#FFD93D]/20 transition-shadow shadow-sm text-[#2D3436]/60 appearance-none font-bold">
                         <option>Wähle einen Anlass</option>
                         <option>Porträt-Power</option>
                         <option>Hochzeits-Glück</option>
                         <option>Business-Fresh</option>
                         <option>Event-Vibe</option>
                         <option>Ganz was anderes!</option>
                      </select>
                ...
                <div className="space-y-3">
                   <label className="text-xs font-black text-[#2D3436] uppercase tracking-widest ml-1">Deine Message</label>
                   <Textarea placeholder="Erzähl uns von deiner bunten Idee..." className="bg-white border-none rounded-[32px] py-8 px-8 h-48 focus:ring-4 focus:ring-[#FF7E67]/20 transition-shadow shadow-sm resize-none font-bold placeholder:font-medium placeholder:text-[#2D3436]/30" />
                </div>
                ...
                <div className="flex items-center justify-center gap-4 text-[10px] text-center text-[#2D3436]/40 uppercase font-black tracking-widest">
                   ...
                   <span>Datenschutz ist uns heilig</span>
