import { Star, Quote, Heart, Utensils } from "lucide-react";
  ...
  const testimonials = [
    {
      name: "Sabine & Thomas",
      role: "Stammgäste",
      text: "Das Kalbsschnitzel ist einfach Weltklasse! Aber was uns immer wieder herzieht, ist die herzliche Art von Max und seinem Team. Man fühlt sich wie bei Freunden.",
      rating: 5,
      image: "https://images.unsplash.com/photo-1583939003579-730e3918a45a?q=80&w=200&auto=format&fit=crop",
      color: "bg-[#16332C]/5 border-[#16332C]/10 text-[#16332C]",
    },
    {
      name: "Markus R.",
      ...
      color: "bg-[#C5A059]/5 border-[#C5A059]/10 text-[#C5A059]",
    },
    {
      name: "Lena S.",
      role: "Veggie-Fan",
      ...
      color: "bg-[#5C4033]/5 border-[#5C4033]/10 text-[#5C4033]",
    },
    {
      name: "Christian H.",
      role: "Unternehmer",
