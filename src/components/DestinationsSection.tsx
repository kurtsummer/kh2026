      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="flex flex-col md:flex-row items-end justify-between mb-20 gap-8">
          <div className="space-y-6">
            <div className="inline-flex items-center gap-3 bg-amber-400 text-sky-950 px-8 py-3 rounded-full text-[10px] font-black uppercase tracking-[0.4em] shadow-xl shadow-amber-400/20">
              Top Reiseziele 2024
            </div>
            <h2 className="text-5xl md:text-7xl font-black text-slate-900 leading-[0.9] tracking-tighter">
              Inspiration für <br />
              <span className="text-sky-600 italic">Ihren Urlaub</span>
            </h2>
          </div>
        ...
        <div className="mt-24 text-center">
          <Link to="/reiseziele">
            <Button size="lg" className="bg-sky-600 hover:bg-sky-700 text-white rounded-[2.5rem] px-16 h-24 text-2xl font-black transition-all shadow-2xl shadow-sky-200 group active:scale-95">
