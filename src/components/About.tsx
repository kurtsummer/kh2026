      ...
      <div className="container mx-auto px-6 md:px-12">
        <div className="grid lg:grid-cols-2 gap-20 items-center">
          <div className="relative animate-in fade-in slide-in-from-left-8 duration-700">
             <div className="relative z-10 rounded-[60px] overflow-hidden shadow-2xl aspect-square border-[12px] border-[#FDF8F1] -rotate-3 hover:rotate-0 transition-transform duration-500 bg-gray-100">
               <img 
          ...
          <div className="space-y-10 animate-in fade-in slide-in-from-right-8 duration-700 delay-200">
            <div className="space-y-6">
              ...
              <p className="text-xl text-[#16332C]/60 font-medium leading-relaxed">
              ...
              <p className="text-lg text-[#16332C]/60 font-medium leading-relaxed">
            ...
            <div className="grid grid-cols-2 gap-8 pt-8 border-t border-[#16332C]/10">
              <div className="space-y-4 group">
                ...
                <div>
                  <h4 className="text-2xl font-black text-[#16332C]">Mit Seele</h4>
                  <p className="text-[#16332C]/40 font-bold uppercase text-xs tracking-widest mt-1">Echte Gastfreundschaft</p>
                </div>
              </div>

              <div className="space-y-4 group">
                <div className="bg-[#16332C]/10 p-4 rounded-3xl w-fit group-hover:scale-110 transition-transform">
                  <Utensils className="text-[#16332C] w-8 h-8" />
                </div>
                <div>
                  <h4 className="text-2xl font-black text-[#16332C]">Lokal</h4>
                  <p className="text-[#16332C]/40 font-bold uppercase text-xs tracking-widest mt-1">Zutaten aus der Heimat</p>
                </div>
              </div>
            </div>

            <div className="bg-[#16332C] p-8 rounded-[40px] text-white flex items-center gap-6 shadow-2xl relative group overflow-hidden">
               ...
               <div className="bg-white/10 p-4 rounded-2xl">
                 <Wine className="text-[#C5A059] w-10 h-10" />
               </div>
               <div>
