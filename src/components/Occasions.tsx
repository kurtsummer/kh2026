...
import { Heart, PartyPopper, Users, Star } from "lucide-react";
...
const Occasions = () => {
  return (
    <section id="occasions" className="py-24 bg-background transition-colors duration-300">
      <div className="container mx-auto px-4 text-center">
        ...
        >
          <h2 className="text-primary text-sm font-bold uppercase tracking-[0.3em] mb-4">Anlässe</h2>
          <h3 className="text-3xl md:text-4xl lg:text-5xl mb-6 text-secondary dark:text-primary">Für jeden Anlass die richtige Note</h3>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {occasions.map((item, index) => (
            <motion.div
              ...
              className="bg-card p-8 rounded-[2rem] shadow-sm hover:shadow-xl transition-all duration-300 border border-primary/5 flex flex-col items-center text-center"
            >
              <div className="p-4 rounded-2xl mb-6 bg-primary/10 text-primary">
                <item.icon size={32} />
              </div>
