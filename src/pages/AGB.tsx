      ...
      <main className="container mx-auto px-6 py-32 md:py-40 max-w-4xl">
        ...
        <div className="space-y-12 text-lg leading-relaxed text-[#16332C]/80 font-medium">
          <section className="bg-white p-10 rounded-[40px] shadow-sm border border-[#16332C]/5">
            <h2 className="text-2xl font-black text-[#16332C] mb-4">§ 1 Geltungsbereich</h2>
          ...
          <section className="bg-white p-10 rounded-[40px] shadow-sm border border-[#16332C]/5">
            <h2 className="text-2xl font-black text-[#16332C] mb-4">§ 2 Vertragsschluss</h2>
          ...
          <section className="bg-white p-10 rounded-[40px] shadow-sm border border-[#16332C]/5">
            <h2 className="text-2xl font-black text-[#16332C] mb-4">§ 3 Reservierungen und Stornierungen</h2>
          ...
          <section className="bg-white p-10 rounded-[40px] shadow-sm border border-[#16332C]/5">
            <h2 className="text-2xl font-black text-[#16332C] mb-4">§ 4 Preise und Zahlung</h2>
          ...
          <section className="bg-white p-10 rounded-[40px] shadow-sm border border-[#16332C]/5">
            <h2 className="text-2xl font-black text-[#16332C] mb-4">§ 5 Haftung</h2>
          ...
          <section className="bg-white p-10 rounded-[40px] shadow-sm border border-[#16332C]/5">
            <h2 className="text-2xl font-black text-[#16332C] mb-4">§ 6 Jugendschutz</h2>
