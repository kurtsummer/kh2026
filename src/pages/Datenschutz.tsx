      ...
      <main className="container mx-auto px-6 py-32 md:py-40 max-w-4xl">
        ...
        <div className="space-y-12 text-lg leading-relaxed text-[#2D3436]/80 font-medium">
          <section className="bg-white p-10 rounded-[40px] shadow-sm border border-[#2D3436]/5">
            <h2 className="text-2xl font-black text-[#2D3436] mb-4">1. Datenschutz auf einen Blick</h2>
            <h3 className="text-xl font-black mb-2 text-[#45B7AF]">Allgemeine Hinweise</h3>
            <p>Die folgenden Hinweise geben einen einfachen Überblick darüber, was mit Ihren personenbezogenen Daten passiert, wenn Sie diese Website besuchen. Personenbezogene Daten sind alle Daten, mit denen Sie persönlich identifiziert werden können.</p>
          </section>

          <section className="bg-white p-10 rounded-[40px] shadow-sm border border-[#2D3436]/5">
            <h2 className="text-2xl font-black text-[#2D3436] mb-4">2. Datenerfassung auf dieser Website</h2>
            <h3 className="text-xl font-black mb-2 text-[#FF7E67]">Wer ist verantwortlich für die Datenerfassung?</h3>
            ...
            <h3 className="text-xl font-black mt-6 mb-2 text-[#FF7E67]">Wie erfassen wir Ihre Daten?</h3>
          ...
          <section className="bg-white p-10 rounded-[40px] shadow-sm border border-[#2D3436]/5">
            <h2 className="text-2xl font-black text-[#2D3436] mb-4">3. Hosting</h2>
          ...
          <section className="bg-white p-10 rounded-[40px] shadow-sm border border-[#2D3436]/5">
            <h2 className="text-2xl font-black text-[#2D3436] mb-4">4. Ihre Rechte</h2>
